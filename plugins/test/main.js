var templates = [
    //"root/externallib/text!root/plugins/test/theme.css",
    //"root/externallib/text!root/plugins/test/login.html",
    "root/externallib/text!root/plugins/test/program.html"
];
...
define(templates, function (theme, loginForm, program) {
    var plugin = {
        ...
        routes: [
            ["test", "show_program", "showProgram"]
        ],

        showProgram: function() {
            var tpl = {};
            var html = MM.tpl.render(program, tpl);
            MM.panels.show('center', html, {title: MM.lang.s("test")});
        }
    };
